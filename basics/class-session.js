...
// // Sets the inherited methos and properties of the base class
// PurchasedItem.prototype = Object.create(Item.prototype);
// PurchasedItem.prototype.constructor = PurchasedItem;

// // Create a new method just for the extended PurchasedItem class
// PurchasedItem.prototype.getDetailsWithPrice = function () {
//     return `${this.name} - ${this.category} - $${this.price}`;
// }

// var item = new Item('Coffe', 'Food');

// item.category = 'Drinks';

// var purchasedItem = new PurchasedItem('Coffe', 'Drinks', '2.49');
...
// let purchasedItem = new PurchasedItem('Coffe', 'Drinks', '2.49');
